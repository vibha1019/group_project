...
#hamster {
    ...
    bottom: 50px;
    left: 0;
    width: 50px; /* Adjust the width of each frame in your sprite */
    height: 180px; /* Adjust the height of each frame in your sprite */
    ...
    animation: hamsterAnimation 0.5s linear infinite; /* Adjust the animation duration based on your preferences */
}
@keyframes hamsterAnimation {
    0% { background-position: 0 0; }
    100% { background-position: -400px 0; } /* Adjust based on the total width of your sprite */
} 
    ...
    <script>
        ...
        window.addEventListener('keydown', (event) => {
            if (event.key === 'ArrowLeft') {
                hamster.style.animation = 'hamsterAnimationLeft 0.5s steps(4) infinite';
            } else if (event.key === 'ArrowRight') {
                hamster.style.animation = 'hamsterAnimation 0.5s steps(4) infinite';
            }
        });
<script>
         </style>
