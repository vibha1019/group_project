...
<head>
    ...
    <style>
        body {
            margin: 0;
            overflow: hidden;
            background-image: url('https://raw.githubusercontent.com/vibha1019/group_project/main/images/farmbg.jpg');
...
style>
  ...
  button:active + embed { display: block; }
    ...
    // play Sound when game is started
<embed src="bgmusic.mp3" />
<body>
    <div id="hamster">🐹</div>
    <div id="score">Score: 0</div>
    <div id="game-over">Game Over! Your final score: <span id="final-score">0</span> Press space to restart</div>
    <script>
