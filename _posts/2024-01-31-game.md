...
#hamster {
    ...
    bottom: 50px;
    left: 0;
    width: 64px; /* Adjust the width of each frame in your sprite */
    height: 64px;
    background-size: 200px 200px; /* Adjust the background size to increase the scale factor */
...
@keyframes hamsterAnimation {
    ...
    to { background-position: -256px; } /* Adjust based on the total width of your sprite */
} 
        #score {
            position: absolute;
            bottom: 10px;
