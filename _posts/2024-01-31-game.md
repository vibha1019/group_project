...
<head>
    ...
    <style>
        ...
        .falling-item {
         position: absolute;
         font-size: 5em; /* Adjust the font size to make the carrots bigger */
...
<body>
    ...
    <script>
        ...
        function createFallingItem() {
            ...
            const randomLeft = Math.random() * (document.body.clientWidth - 50); // Adjust 50 based on carrot width
