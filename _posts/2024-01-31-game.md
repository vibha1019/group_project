...
#hamster {
    ...
    height: 120px;
    background-size: 400px 400px; /* Adjust the background size to increase the scale factor */
 /* Adjust the height of each frame in your sprite */
    ...
    animation: hamsterAnimation 0.5s steps(4) linear infinite; /* Adjust the animation duration and steps based on your sprite */
}
@keyframes hamsterAnimation {
    0% { background-position: 0 0; }
    100% { background-position: 0 -256px; } /* Adjust based on the total width of your sprite */
} 
        #score {
            position: absolute;
            bottom: 10px;
