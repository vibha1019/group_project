...
#hamster {
    ...
    bottom: 50px;
    left: 20px;
    width: 110px; /* Adjust the width of each frame in your sprite */
    ...
    animation: hamsterAnimation 1s linear infinite; /* Adjust the animation duration based on your preferences */
}
