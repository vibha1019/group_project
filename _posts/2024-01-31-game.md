...
#hamster {
    ...
    bottom: 50px;
    left: 20px;
    width: 100px; /* Adjust the width of each frame in your sprite */
    height: 190px; /* Adjust the height of each frame in your sprite */
...
@keyframes hamsterAnimation {
    ...
    100% { background-position: -430px 0; } /* Adjust based on the total width of your sprite */
} 
